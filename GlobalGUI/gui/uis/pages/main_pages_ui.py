...
"I will try to always record a new tutorial when adding a new Widget and updating the project on Patreon before launching on GitHub and GitHub after the public release.", None))
        ...
        #self.continuous_scanY_but.setText(QCoreApplication.translate("MainPages", u"Find Reference", None)) # further improve later
        self.find_reference_but.setText(QCoreApplication.translate("MainPages", u"Find Reference", None)) # further improve later
